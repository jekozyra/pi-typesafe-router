...
```json
{"type":"typesafe","model":"jev-1.13.0","auth":{"source":"env","variable":"TYPESAFE_API_KEY"}}
```
...
```json
{"type":"cloudflare","accountId":"0123456789abcdef0123456789abcdef","model":"typesafe/jev","auth":{"source":"env","variable":"CLOUDFLARE_API_TOKEN"}}
```
...
```json
{"type":"vercel","model":"typesafe-ai/jev","zeroDataRetention":true,"auth":{"source":"env","variable":"AI_GATEWAY_API_KEY"}}
```
